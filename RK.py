...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7527768602:AAEBW16wz1DNYzn-uIc5ks8zEOA_GfXAdCk'
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        ...
        "*Let the war begin! ⚔️💥 MADE BY @Anupeiejfj*"
    )
...
async def attack(update: Update, context: CallbackContext):
    ...
    args = context.args
    if len(args) != 3:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ Usage: /attack <ip> <port> <duration>* MADE BY @Anupeiejfj", parse_mode='Markdown')
        return
